...
variable "environment" {
  type        = string
  description = "This is the environment of the application"
  default     = null
}
...
variable "environment_vars" {
  ...
  description = "The environment variables to pass to the container. This is a list of maps. map_environment overrides environment_vars"
  default     = []
}
...
variable "map_environment" {
  type        = map(string)
  description = "The environment variables to pass to the container. This is a map of string: {key: value}. map_environment overrides environment_vars"
  default     = null
}
...
#       autoprovision = bool
#       driver        = string
#       driver_opts   = string #map(string) Changing this variable type since I do not need to map anything now and it is giving an error.
#       labels        = string #map(string)
#       scope         = string
#     }))
